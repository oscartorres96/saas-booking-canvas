...
const Login = () => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        setTimeout(() => {
            ...
            if (values.email === "admin@bookingcanvas.com" && values.password === "admin123") {
                toast.success("Bienvenido Administrador");
                navigate("/admin");
            } else if (values.email === "dentista@sonrisas.com" && values.password === "123456") {
                toast.success("Bienvenido a tu Panel de Negocio");
                navigate("/dashboard");
            } else {
            ...
            <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12 text-white">
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <p className="text-lg text-slate-300 mb-8">
                        La plataforma todo en uno para nutriólogos, barberías, dentistas y más.
                        Simplifica tus citas y haz crecer tu clientela.
                    </p>
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-muted-foreground mt-2">
                            Ingresa a tu panel de control para gestionar tu negocio.
                        </p>
                    </div>
                            ...
                            <Card className="border-none shadow-none lg:shadow-sm lg:border">
                                ...
                                <CardContent className="px-0 lg:px-6 space-y-4">
                                    <div className="grid gap-4">
                                        <Button variant="outline" className="w-full" onClick={() => toast.info("Funcionalidad de registro próximamente")}>
